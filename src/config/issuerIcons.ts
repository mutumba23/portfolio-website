import { faBuilding, faGlobe, faGraduationCap, faShield, faCheck, faLaptopCode } from '@fortawesome/free-solid-svg-icons';
import { faMicrosoft, faGoogle } from '@fortawesome/free-brands-svg-icons';
import { IconDefinition } from '@fortawesome/fontawesome-common-types';

export const PROVIDER_ICON_MAP: Record<string, IconDefinition> = {
